  ...
  return (
    <section className="relative min-h-screen py-20 overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <motion.div className="mb-16 md:mb-20" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-cyan-400 mb-4 font-mono">PORTFOLIO.EXECUTE()</h2>
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl">
            Showcasing a collection of projects spanning video editing, visual effects, and digital innovation
          </p>
          <div className="w-16 sm:w-20 h-1 bg-gradient-to-r from-cyan-500 to-orange-500 mt-6"></div>
        </motion.div>
