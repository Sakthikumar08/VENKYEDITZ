    ...
    <section className="relative min-h-screen py-32 overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <motion.div className="mb-20" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
          <h1 className="text-5xl md:text-7xl font-bold text-cyan-400 mb-4 font-mono">GALLERY.RENDER()</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {galleryItems.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className={`group relative h-80 rounded-xl overflow-hidden border backdrop-blur-sm hover:shadow-lg transition-all cursor-pointer ${
                item.accent === "cyan"
